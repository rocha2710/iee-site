...
import Header from './componentes/site/Header';
import { useSession, signIn, signOut } from 'next-auth/react'; // Importa hooks do NextAuth
import Status from './componentes/site/Status';
export default function Home() {
  const { data: session } = useSession(); // Obtém os dados da sessão

  // Função para realizar o login
  const handleLogin = async () => {
    await signIn('credentials', { // Chama a função de login com credenciais
      email: 'seu-email@example.com', // Insira o e-mail
      password: 'sua-senha', // Insira a senha
    });
  };
  ...
  return (
    ...
    <footer className="pt-10 bg-gradient-to-b from-red-600 to-red-700">
      ...
      e                              Título Menu
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-white">© 2024 IEE - Todos os direitos reservados.</p>
